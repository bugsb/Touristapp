    ...
    return {
        Engines: {
            ...
            duckduckgo: function () {
                ...
                // patterns that the engine can resolve
                var capabilities = [
                    "Ask what something is like 'where is hawa mahal'",
                    "Ask where something is like 'where is Nahargarh fort'?",
                    "Ask about a person like 'What is the weather status'?",
                    "Status of Jaipur Metro",
                ];
        ...
        addChatEntry: function addChatEntry(text, origin) {
            ...
            if (text == '') {
                text = 'Sorry, I am still exploring jaipur';
            }
